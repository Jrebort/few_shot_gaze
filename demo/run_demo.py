...
ted_weights = torch.load(ted_parameters_path,map_location=torch.device(device))
...
maml_weights = torch.load(full_maml_parameters_path,map_location=torch.device(device))
